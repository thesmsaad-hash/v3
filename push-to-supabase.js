...
const blogPosts = [
  {
    id: '1',
    title: 'Mastering Cinematic Color Grading in DaVinci Resolve',
    category: 'Video Editing',
    excerpt: 'Deep dive into professional color grading workflows using DaVinci Resolve, from primary corrections to advanced node-based compositing.',
  ...
  {
    id: '2',
    title: 'Green Screen Keying & VFX Compositing Workflow',
    category: 'VFX & Compositing',
    excerpt: 'Professional chroma key compositing techniques using After Effects and DaVinci Resolve for seamless green screen removal.',
  ...
  },
  {
    ...
    category: 'Web & AI',
    excerpt: 'A complete guide to building a professional creator portfolio using React 18, TypeScript, Vite, and TailwindCSS with dark mode and smooth routing.',
  ...
  {
    id: '4',
    title: 'AI-Powered Video Editing Workflows with n8n & Ollama',
    category: 'AI Technology',
    excerpt: 'Automating video production pipelines using n8n, local LLM models with Ollama, and AI caption generation for social media content.',
  ...
  {
    id: '5',
    title: 'Short-Form Content Strategy: Reels & Shorts Editing',
    category: 'Post Production',
    excerpt: 'Breaking down the fast-cut editing rhythm, audio engineering, and thumbnail strategy that drives millions of views on short-form platforms.',
  ...
  {
    id: '6',
    title: 'Motion Graphics & Kinetic Typography in After Effects',
    category: 'VFX & Compositing',
    excerpt: 'Creating high-impact motion graphics with kinetic typography, logo animations, and dynamic transitions using After Effects expressions.',
